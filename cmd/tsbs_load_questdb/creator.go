...
func (d *dbCreator) DBExists(dbName string) bool {
        ...
        r, err = execQuery(questdbRESTEndPoint, "CREATE TABLE cpu (timestamp TIMESTAMP) timestamp(timestamp) PARTITION BY DAY WITH o3MaxUncommittedRows=250000, o3CommitHysteresis=240s")
        if err != nil {
