...
DATABASE_NAME=${DATABASE_NAME:-astimescaledb}
DATABASE_HOST=${DATABASE_HOST:-192.168.64.3}
DATABASE_PORT=${DATABASE_PORT:-30823}
DATABASE_PWD=${DATABASE_PWD:-aef31a17aae11d04181d5d009}
